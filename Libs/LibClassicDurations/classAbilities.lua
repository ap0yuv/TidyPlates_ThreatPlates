...
Spell( 20572 ,{ duration = 15, type = "BUFF" }) -- Blood Fury
...
Spell({ 2943, 19249, 19251, 19252, 19253, 19254, 25460 }, { duration = 120 }) -- Touch of Weakness Effect
Spell({ 13896, 19271, 19273, 19274, 19275, 25441 }, { duration = 15, type = "BUFF" }) -- Feedback
Spell({ 2651 }, { duration = 15, type = "BUFF" }) -- Elune's Grace
Spell({ 9035, 19281, 19282, 19283, 19284, 19285, 25470 }, { duration = 120 }) -- Hex of Weakness
...
Spell({ 7001, 27873, 27874, 28276 }, { duration = 10, type = "BUFF", buffType = "Magic" }) -- Lightwell Renew
Spell( 552, { duration = 20, type = "BUFF", buffType = "Magic" }) -- Abolish Disease
Spell({ 17, 592, 600, 3747, 6065, 6066, 10898, 10899, 10900, 10901, 25217, 25218 }, {duration = 30, type = "BUFF", buffType = "Magic" }) -- PWS
...
Spell({ 132 }, { duration = 600 }) -- Detect Invisibility
...
Spell({ 16191 }, { duration = 12, type = "BUFF" }) -- Mana Tide Totem
...
Spell({ 3043 }, { duration = 20 }) -- Scorpid Sting
Spell({ 3034 }, { duration = 8 }) -- Viper Sting
Spell({ 19386, 24132, 24133, 27068 }, { duration = 12 }) -- Wyvern Sting
Spell({ 24131, 24134, 24135, 27069 }, { duration = 12 }) -- Wyvern Sting Dot
